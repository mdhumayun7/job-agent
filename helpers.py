...
def save_results(jobs):
    ...
    try:
        ...
        for row, job in enumerate(jobs, 2):
            ...
            if rating_val >= 4.5:
                rating_cell.fill = PatternFill("solid", fgColor="86EFAC")
            elif rating_val >= 4.0:
                rating_cell.fill = PatternFill("solid", fgColor="BBF7D0")
            elif rating_val >= 3.5:
                rating_cell.fill = PatternFill("solid", fgColor="FDE68A")
            elif rating_val > 0:
                rating_cell.fill = PatternFill("solid", fgColor="FCA5A5")
            ...
            if score >= 60:
                ws.cell(row=row, column=1).fill = PatternFill("solid", fgColor="86EFAC")
            elif score >= 30:
                ws.cell(row=row, column=1).fill = PatternFill("solid", fgColor="FDE68A")
            if isinstance(days_ago, int) and days_ago <= 3:
                ws.cell(row=row, column=14).fill = PatternFill("solid", fgColor="86EFAC")
            elif isinstance(days_ago, int) and days_ago <= 7:
                ws.cell(row=row, column=14).fill = PatternFill("solid", fgColor="FDE68A")
